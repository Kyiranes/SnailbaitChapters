var SnailBait = function () {
   ...
   this.runBehavior = {
      ...
      execute: function (sprite, 
               ...
               var runnerOnPlatform = false;
               for (var i = 0; i < snailBait.platforms.length; ++i) {
                var platform = snailBait.platforms[i]
                var platformLeft = platform.left - platform.hOffset;
                
                if (sprite.top + snailBait.RUNNER_CELLS_HEIGHT >= platform.top && sprite.top + snailBait.RUNNER_CELLS_HEIGHT <= platform.top + platform.height && sprite.left + snailBait.RUNNER_CELLS_WIDTH > platformLeft && sprite.left < platformLeft + platform.width) {
